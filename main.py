...
def attack(char_name: str, char_class: str) -> str:
    """Приминение атаки для разных персонажей."""
...
def defence(char_name: str, char_class: str) -> str:
    """Приминение защиты для разных персонажей."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Приминение специального умения для разных персонажей."""
    if char_class == 'warrior':
        return (f'{char_name} '
    ...
    return (f'{char_name} не использовал суперсилу')
